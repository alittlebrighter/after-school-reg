...
export class ParentControllerBase {
  ...
  async create(
    @common.Body() data: ParentCreateInput,
    ...
    if (invalidAttributes.length) {
      ...
      throw new errors.ForbiddenException(
        `providing the properties: ${properties} on ${"Parent"} creation is forbidden for roles: ${roles}`
      );
    }
  ...
  async update(
    ...
    if (invalidAttributes.length) {
      ...
      const roles = userRoles
        ...
        .join(",");
      throw new errors.ForbiddenException(
        `providing the properties: ${properties} on ${"Parent"} update is forbidden for roles: ${roles}`
      );
    }
    try {
